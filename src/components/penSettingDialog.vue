  ...
  <div class="penSettingBox" style="display:none">
    <div class="pen-settings" id="pen-settings">
      <div class="wrap">
        <div class="tab">
          <nav class="tab-menus">
            <a class="active" href="javascript:;" id="html-menu">Html</a>
            <a href="javascript:;" id="css-menu">Css</a>
            <a href="javascript:;" id="js-menu">Javascript</a>
          </nav>
          ...
          <form id="form-settings">
            <div class="tab-cts">
              <div class="tab-ct active">
                <div class="form-item">
                  <h4 class="form-tit">Html 文档类型</h4>
                  <div class="form-ct">
                    <select name="HtmlDocType" v-model="HtmlDocType" class="j-insubmit">
                      <option value="1">Html5 模式</option>
                      <option value="2">HTML 4.01 严格模式</option>
                      <option value="3">HTML 4.01 过度模式</option>
                      <option value="4">HTML 4.01 框架模式</option>
                      <option value="5">XHTML 1.0 严格模式</option>
                      <option value="6">XHTML 1.0 过渡模式</option>
                      <option value="7">XHTML 1.0 框架模式</option>
                      <option value="8">XHTML 1.1 严格模式</option>
                    </select>
                  </div>
                </div>

                <div class="form-item">
                  <h4 class="form-tit">Html 样式名称</h4>
                  <div class="form-ct">
                    <input
                      type="text"
                      name="HtmlClassName"
                      v-model="HtmlClassName"
                      placeholder="class"
                      class="j-insubmit"
                    >
                  </div>
                ...
                <div class="form-item">
                  <h4 class="form-tit">Html head 头部</h4>
                  <div class="form-ct">
                    <textarea
                      name="HtmlHeadStuff"
                      v-model="HtmlHeadStuff"
                      class="j-insubmit"
                      placeholder="&lt;meta&gt; or &lt;link&gt; or &lt;script&gt;"
                    ></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-ct">
                <div class="form-item">
                  <h4 class="form-tit">Javascript 模式</h4>
                  <div class="form-ct">
                ...
                <div class="form-item">
                  <h4 class="form-tit">Javascript 引用</h4>
                  <div class="form-ct">
                    <textarea
                      name="JsExternal"
                      v-model="JsExternal"
                  ...
                  <div class="form-c cf quick-add-box">
                    <select id="js-quick-add" class="quick-add-select" v-on:change="quickAdd">
                      <option value="none">---</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.6.1/angular.min.js"
                      >Angular</option>
                      <option
                      ...
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/ember.js/2.11.0/ember.min.js"
                      >Ember</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js"
                      >GreenSock TweenMax</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.0.6/handlebars.min.js"
                      >Handlebars</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"
                      >jQuery</option>
                      <option
                      ...
                      >Polymer</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/react/15.4.2/react.min.js"
                      >React</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/react/15.4.2/react-dom.min.js"
                      >React DOM</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.4.1/snap.svg-min.js"
                      >Snap.svg</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/three.js/84/three.min.js"
                      >Three.js</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"
                      >Underscore</option>
                      <option
                        value="https://cdnjs.cloudflare.com/ajax/libs/vue/2.1.10/vue.min.js"
                      >Vue</option>
                      <option
                  ...
                  <div class="form-c cf quick-select">
                    <a
                      data-src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"
                      v-on:click="quickAdd2"
                      href="javascript:;"
                    >jQuery</a>
                  </div>
                </div>
