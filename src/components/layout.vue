      ...
      <div class="web-editor web-editor1" data-type="editor1">
        <div class="boxes boxes-row boxes-row-2" id="boxes-row">
          <div class="box box-row box-code">
            <div class="boxes boxes-col boxes-col-3" id="boxes-col">
              <div class="box box-col">
                ...
                <div class="vs-editor j_rp" data-type="html"></div>
              ...
              <div class="box box-col">
                ...
                <div class="vs-editor j_rp" data-type="css"></div>
                <div class="resizer resizer-col"></div>
              </div>
              ...
              <div class="box box-col">
                <div class="box-menu">
                  <div class="editor-actions">
                    ...
                    <h2 class="box-title">JS</h2>
                  </div>
                </div>
                <div class="vs-editor j_rp" data-type="javascript"></div>
              </div>
            </div>
          ...
          <div class="box box-row box-result" id="box-result">
            ...
            <div class="result-container j_rp" id="result-container"></div>
          </div>
        </div>
      </div>
    </template>
      ...
      <div class="web-editor web-editor3" data-type="editor3">
        <div class="tab">
          <div class="tab-menus cf" id="tabMenus">
            <div class="tab-menu active">HTML</div>
            <div class="tab-menu">CSS</div>
            <div class="tab-menu">JS</div>
            <div class="tab-menu">Result</div>
